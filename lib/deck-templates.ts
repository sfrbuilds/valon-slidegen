...
export const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    outline: [
      ...
      { layout: "content", heading: "Key metrics dashboard", hint: "Chart of the primary revenue KPI trend (revenue run-rate or ARR). Use chartData, plus 2 or 3 short takeaway bullets alongside the chart." },
      { layout: "content", heading: "Serviced volume trend", hint: "Chart of serviced portfolio volume (e.g. UPB in $B) with chartData, plus 2 or 3 takeaway bullets. Revenue follows serviced volume via a basis-point take, so volume is the leading indicator; say so if the source material supports it." },
